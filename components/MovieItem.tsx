...
export default function MovieItem({ key, movie }: Props) {
    ...
    const likeRef = useRef<SVGSVGElement | null>(null);
    ...
    return (
        <div className="max-w-2 backdrop-saturate-100 min-h-fit">
            <Image className="" width={150} height={150} style={{ 'width': 'auto', 'height': 'auto' }} src={posterPath + movie.poster_path} alt={`{movie.title} poster`}/>
            {/* <div
        className={`bg-[url("${posterPath + movie.poster_path}")] object-cover h-96 w-full bg-cover bg-center text-center`}></div> */}
            ...
            <div id="likes-and-dislikes" className="flex flex-row gap-2 my-2">
                <div className="border border-green-500 px-4 py-1 rounded-md hover:shadow-md hover:shadow-green-200 hover:cursor-pointer"
                ...
                <div className="border border-rose-500 px-4 py-1 rounded-md hover:shadow-md hover:shadow-rose-200 hover:cursor-pointer"
                    data-movie-title={movie.title}
